        ...
        <div class="card-body">
          ...
          <form action="{{ route('admin.home-slider.update', ['home_slider' => $slider_home->id]) }}" method="POST" autocomplete="off" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
              ...
              <input id="link_1" name="link_1" type="text" class="form-control" value="{{$slider_home->link_1}}" placeholder="Complete este campo...">
            </div>
            <div class="mb-3">
              <label for="link_2" class="form-label">link 2</label>
              <input id="link_2" name="link_2" type="text" class="form-control" value="{{$slider_home->link_2}}" placeholder="Complete este campo...">
            </div>
